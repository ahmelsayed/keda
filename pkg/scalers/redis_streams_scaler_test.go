...
func TestParseRedisStreamsMetadata(t *testing.T) {
	...
	testCases := []testCase{
		...
		{"with host and port", map[string]string{"stream": "my-stream", "consumerGroup": "my-stream-consumer-group", "pendingEntriesCount": "15", "hostFromEnv": "REDIS_HOST", "port": "6379", "databaseIndex": "0", "enableTLS": "false"}, map[string]string{
			"REDIS_HOST":     "myredis",
			"REDIS_PASSWORD": "foobarred",
		}, authParams},
	}
